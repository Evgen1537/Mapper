 ...
 */
public class LayerDtoListCell extends ListCell<LayerDto> {

	private final boolean visiblityProperty;
	private Predicate<LayerDto> currentLayerChecker;

	public LayerDtoListCell() {
		this(false);
	}

	public LayerDtoListCell(boolean visibilityProperty) {
		this(visibilityProperty, layer -> false);
	}

	public LayerDtoListCell(Predicate<LayerDto> currentLayerChecker) {
